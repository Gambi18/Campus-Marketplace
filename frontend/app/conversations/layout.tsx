...
export default function ConversationsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div>
        <Navbar/>
        <div className="flex w-full max-w-6xl mx-auto md:border md:border-gray-100 md:rounded-xl md:shadow-sm bg-white h-[calc(100dvh-4rem)] md:h-[calc(100dvh-140px)] overflow-hidden">
